...
void VulkanEngine::init_background_pipelines()
{
    ...
    VK_CHECK(vkCreateComputePipelines(_device, VK_NULL_HANDLE, 1, &computePipelineCreateInfo, nullptr, &backgroundEffects[0].pipeline));
    ...
    VK_CHECK(vkCreateComputePipelines(_device, VK_NULL_HANDLE, 1, &computePipelineCreateInfo, nullptr, &backgroundEffects[1].pipeline));
